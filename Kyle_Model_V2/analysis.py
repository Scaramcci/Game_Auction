...
def analyze_configuration(config_name, episodes=1000, models_dir="Kyle_Model_V2/models"):
    ...
    try:
        ...
        # 生成分析报告
        env_configs = {
            'baseline_static': {'sigma_u': 0.8, 'sigma_v': 1.2},
            'baseline_dynamic': {'sigma_u': 0.8, 'sigma_v': 1.2},
            'high_noise': {'sigma_u': 1.5, 'sigma_v': 1.2},
            'low_noise': {'sigma_u': 0.5, 'sigma_v': 1.2},
            'long_term': {'sigma_u': 0.8, 'sigma_v': 1.5}
        }
